...
const privacySections = [
  {
    ...
    text: "بعد موافقتك على ملفات التحليلات والإعلانات، نستخدم Google Analytics وGoogle Ads لقياس الزيارات والتسجيلات الناجحة. نحفظ أول مصدر معروف وآخر حملة معروفة على جهازك لمدة تصل إلى 90 يومًا، وقد نربطهما بحساب متجرك عند التسجيل. لا نرسل كلمة المرور أو رمز التحقق أو بيانات الاتصال في أحداث التسجيل. يمكنك رفض القياس أو تغيير اختيارك من إعدادات ملفات الارتباط. سؤال «عرفتنا منين؟» اختياري وتُحفظ إجابته منفصلة عن التتبّع التلقائي.",
  },
  {
