...
const comparisons = [
  {
    ...
    headline: "باقة النمو بـ 399 ج.م بدلاً من 50 دولاراً",
  ...
  },
  {
    ...
    headline: "ادفع 399 ج.م بدلاً من $29+ شهرياً",
    ...
    <div className="bg-white text-right" dir="rtl">
      ...
      <section className="py-16 bg-gray-950 text-white">
        <div className="container px-4 mx-auto max-w-4xl text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-6 mb-10">
            {[
              { stat: "0 ج.م", label: "للبدء — لا رسوم شهرية", sub: "فقط 3% على كل طلب" },
              { stat: "399 ج.م", label: "باقة النمو الشهرية", sub: "بدلاً من 50 دولاراً في المنافسين" },
      ...
      <section className="py-16 container px-4 mx-auto max-w-3xl">
        ...
        <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
          ...
          <p>
            <strong>متجركو</strong> تقدم الحل الأمثل للتاجر المصري الذي يريد البدء بدون مخاطرة: ابدأ مجاناً بعمولة 3% فقط على كل طلب،
            وانتقل لباقة النمو (399 ج.م) عندما تنمو مبيعاتك أو الباقة الاحترافية (999 ج.م بدون أي عمولة).
